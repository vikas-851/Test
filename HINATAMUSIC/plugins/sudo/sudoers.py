...
from HINATAMUSIC.misc import SUDOERS
from HINATAMUSIC.utils.database import add_sudo, remove_sudo
from HINATAMUSIC.utils.decorators.language import language
from HINATAMUSIC.utils.extraction import extract_user
from HINATAMUSIC.utils.inline import close_markup
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_photo(photo="https://telegra.ph/file/32cf510ac8848cdb58e09.mp4", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ.", show_alert=True)
    else:
