...
from HINATAMUSIC.mongo.readable_time import get_readable_time
from HINATAMUSIC.mongo.afkdb import add_afk, is_afk, remove_afk



@app.on_message(filters.command(["afk", "bye", "brb", "by"], prefixes=["/", "!", "","."]))
