...
from HINATAMUSIC.plugins.tools.pretenderdb import impo_off, impo_on, check_pretender, add_userdata, get_userdata, usr_data
...
AB = [
    [
        InlineKeyboardButton(
            text="Lᴜғғʏ X Nᴇᴛᴡᴏʀᴋ ☠️",
            url="https://t.me/luffyxnetwork",
        ),
    ],
]
