...
from HINATAMUSIC.utils.jarvis_ban import admin_filter
...
def welcomepic(pic, user, chatname, id, uname):
    ...
    font_large = ImageFont.truetype('HINATAMUSIC/assets/annie/ArialReg.ttf', size=65)
    font_small = ImageFont.truetype('HINATAMUSIC/assets/annie/ArialReg.ttf', size=60)
    draw.text((600, 715), f'{user}', fill=(242, 242, 242), font=font_large)
    draw.text((350, 1005), f'{id}', fill=(242, 242, 242), font=font_large)
    draw.text((650, 1308), f"{uname}", fill=(242, 242, 242), font=font_large)
    pfp_position = (2000, 390)
...
async def greet_new_member(_, member: ChatMemberUpdated):
    ...
    if member.new_chat_member and not member.old_chat_member and member.new_chat_member.status != "kicked":
        ...
        try:
            ...
            pic = "HINATAMUSIC/assets/upic.png"
